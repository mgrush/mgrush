// 非必须登录即可访问的页面模块
var loginWhiteList	= ["/home", "/docs", "/user/login", "/manage"];
...
var Handlers	= {
	...
	authorize : function(req, res, next){
		if( loginWhiteList.indexOf(req.path) == -1 && !UserModel.authorize() ) {
...
module.exports = function(app){
	...
	app.all("/:contName/:funcName", Handlers.authorize, function(req, res){
		var contName	= req.params.contName;
